...
public class User extends BasicPojo {
    ...
    @Builder
    public User(Long id,Long storeId,Long enterpriseId,String username,String realName,String password,String sex,String mobil,String email,BigDecimal discountLimit,BigDecimal reduceLimit,String duties,Integer sortNo){
        super(id);
