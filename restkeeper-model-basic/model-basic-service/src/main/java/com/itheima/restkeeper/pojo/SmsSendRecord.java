...
public class SmsSendRecord extends BasicPojo {

    private static final long serialVersionUID = 1L;

    @Builder
    public SmsSendRecord(Long id,String channelName,String channelLabel,Long templateId,String templateNo,String templateCode,String templateType,String signCode,String signName,String mobile,String sendContent,String sendStatus,String sendMsg,String acceptStatus,String acceptMsg,String serialNo,String templateParams){
        super(id);
